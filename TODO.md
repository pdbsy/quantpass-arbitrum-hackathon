...
- 唯一 WIP：**THREAT-001 · Robinhood Chain 专项威胁模型与风险登记**
- 总任务：40
- 已完成：7
- 已就绪：7
...
- [x] **GOV-001 · 冻结测试网范围、角色与架构 ADR** — 已完成 / P0 / Critical / M
  ...
  - 证据：`docs/adr/0001-testnet-mvp-scope-and-authority.md`、`planning/security-boundary.json`、`tools/check-governance.mjs`、`test/governance.test.mjs`

- [ ] **THREAT-001 · Robinhood Chain 专项威胁模型与风险登记** — 进行中 / P0 / Critical / M
