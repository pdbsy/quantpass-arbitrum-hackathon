...
Scope: AlphaForge / Robinhood Chain Testnet / Hackathon. This is local engineering evidence for Macbeth01's integration. It does not authorize merge, deployment, signing, broadcast or hosted publication. XLayer remains paused.
