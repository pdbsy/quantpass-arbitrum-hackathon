...
该S完整覆盖率：行91.54%、语句88.92%、函数91.53%、分支83.67%。报告SHA-256 39d41184498129179709fbd3d372a7c2b0c48ede4b77d5ffa375b69a8d826a4a，阈值仍未达。新一轮正在补齐Git来源、存储恢复和可见导出/重置边界，并把已有实际OSV纳入同候选采集；需重新生成C/R/S与全量结果。见 [本轮记录](phase1/RECOVERY-BOUNDARIES-2026-09-23.md)。
