...
Status: committed source migration prepared; one protected uncommitted Dashboard refresh is USER_ACTION_REQUIRED. No merge, deployment, broadcast or funds operations.
...
| MIG-02 | PR #1 | Macbeth01 integration; source owners in JSON | See inventory.json | Agent Forum | `tools/agent-*; docs/agent-forum.html` | MIGRATED | See CONFLICTS.md | Immutable SHA/blob in inventory.json |
